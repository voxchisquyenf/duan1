...
<section class="contact">
   ...
   <form action="" method="post">
      ...
      <input type="number" name="number" min="0" max="9999999999" placeholder="Nhập số điện thoại của bạn" required onkeypress="if(this.value.length == 10) return false;" class="box">
